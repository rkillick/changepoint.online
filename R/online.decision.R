online.decision<-function(tau,null,alt=NA,penalty="MBIC",n=0,diffparam=1,pen.value=0){
  if(sum(is.na(alt))){
	...
	online.single.decision=function(tau,null,alt,n=0,diffparam=1,pen.value=0){
